...
class CustomDialogEditWidget extends StatefulWidget {
  const CustomDialogEditWidget({super.key});

  @override
  _CustomDialogEditWidgetState createState() => _CustomDialogEditWidgetState();
}

class _CustomDialogEditWidgetState
    extends WidgetStateful<CustomDialogEditWidget, ScheduleController> {
  @override
  void initState() {
    super.initState();
  }
